...
export default function PageHero({ title, tagline, body, image }: {
  title: string
  tagline?: string
  body?: string
  image?: string | null
  ...
  return (
    <div style={{ padding: '12px 14px 4px' }}>
      <div style={{
        ...
        {image && (
          <div style={{ flexShrink: 0, width: 'clamp(88px, 22vw, 150px)', aspectRatio: '1 / 1', borderRadius: '50%', overflow: 'hidden', border: '4px solid #fff', boxShadow: '0 8px 22px rgba(15,23,42,0.16)' }}>
