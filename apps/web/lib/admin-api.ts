...
export function makeCrmApi(execToken: string) {
  return {
    ...
    upsertCategory: (data: { id?: string; name: string; department: string; img?: string | null; bgImage?: string | null; heroBanner?: string | null; heroBannerEs?: string | null; enabled?: boolean }) =>
