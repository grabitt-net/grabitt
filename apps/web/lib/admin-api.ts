...
export function makeCrmApi(execToken: string) {
  return {
    ...
    resolveSupport: (id: string, resolved: boolean) =>
      rpc<any>('crm.resolveSupport', 'mutation', { id, resolved }, execToken),
    ...
    upsertCategory: (data: { id?: string; name: string; department: string; img?: string | null; imgEs?: string | null; bgImage?: string | null; heroBanner?: string | null; heroBannerEs?: string | null; enabled?: boolean }) =>
